...
public:
    ...
    int start_draw()
    {
        ...
        make_start_mtx(); // Начало создания матрицы для игры
...
private:
    ...
    void rerender()
    {
        ...
        // Отрисовка доп строк под mac os
        SDL_Delay(10);
